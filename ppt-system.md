...
```html
<style>
:root{--y:#F2FF62;--c:#333333;--o:#F26B43;--w:#FFFFFF;--s:#5D6269;--sv:#A4A7AB;--l:#F5F5F3;--t:#3C6E89;--f:'Arial','Helvetica Neue',sans-serif}
...
## Logo SVG (Inline — use in .logo div)

```html
<div class="logo">
  <svg width="26" height="26" viewBox="0 0 375 375" fill="none">
    <!-- Use the M symbol from /Users/ai_lab_team/Documents/Bilder/Logos/Logo ohne Hintergrund.svg -->
    <!-- Or embed as <img src="..." width="26" height="26"> -->
  </svg>
</div>
```

**Quickstart logo (base64 PNG fallback):**
```html
<div class="logo">
  <img src="/Users/ai_lab_team/Documents/Bilder/Logos/Logo M (Yellow-Edition).png" 
       width="26" height="26" style="filter:brightness(0)">
</div>
```
